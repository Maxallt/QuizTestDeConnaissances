...
public class PopUpSuppressionController implements Initializable {
	...
	@FXML
	public void valider() {
		DAOSousCategorie.supprSousCategorie(ModificationSousCategorieController.getValeurASupprimer());
