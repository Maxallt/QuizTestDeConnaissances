...
public class ChoixSousCategorieController implements Initializable {
	...
	/** 
	 * Est utile pour le changement de fenetre, il récup�re la fenetre
     ...
     * initialisée, c'est � dire remplie.
	...
	/**
	 * Ce bouton set � valider le choix de sous-catégorie (facultatif)
	...
	/**
	 * Liste qui regroupe toutes les sous catégories de la cat�gorie
	...
	public void chargementQuestions(int idCat) {
		if (difficulteChoisi.equals("Indiff�rent")) {
